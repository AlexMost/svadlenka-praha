...
> **Note**: This repo keeps both `CLAUDE.md` (for Claude Code) and `AGENT.md` (for OpenAI Codex and similar agents) with identical content. When updating one, update the other to match.
